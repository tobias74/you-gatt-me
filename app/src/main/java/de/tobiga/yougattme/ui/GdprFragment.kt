 ...
 * Use the [GdprFragment.newInstance] factory method to
...
class GdprFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val webView: WebView = view.findViewById(R.id.gdprWebView)
        webView.loadUrl("file:///android_asset/gdpr" + myLocale + ".html")
    ...
    companion object {
         ...
         * @return A new instance of fragment GdprFragment.
         */
